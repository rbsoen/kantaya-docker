/******************************************
Nama File : nav_url.js (javascript)
...
function printNavigasi() {
    ...
    document.writeln("<script language='Javascript' src='nav_url.js'></script>");
    ...
    document.writeln(">> <a href='direktori_baru.php' target='isi'>Buat Direktori Baru</a><br>\n");
		document.writeln(">> <a href='tambah_url.php' target='isi'>Tambah URL</a><br>\n");
...
function printNavigasiunit() {
    ...
    for (var i=0; i<x.length; i++) {
        if (expand || x[i][2] <= plevel) {
           ...
           document.writeln("<a href='isi_direktori.php?pdirektorinav="+x[i][0]+"' target='isi'>"+x[i][1]+"</a>");
           //document.writeln("+x[i][0]+");
					 document.writeln("<td><a href='hapus_dir.php?kode_direktori="+x[i][0]+"' target='isi'><img src='../gambar/del.gif' border='0'></a>");
		       document.writeln("</td>");
           document.writeln("</tr>");
        }
    }
