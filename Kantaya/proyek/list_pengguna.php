...
echo "<link rel=stylesheet type='text/css' href='../proyek/forum.css'>\n";
...
echo "<td>\n";
     ...
     echo "<tr>\n";
     echo "<td><a href='list_pengguna.php?pfld=".$pfld."&pfltr=".$pfltr."'>Semua</a></td>\n";
     for ($i=0; $i<25; $i++) {
         echo "<td><a href='list_pengguna.php?pfld=".$pfld."&pfltr=".$pfltr."&pnama=".chr($i+65)."'>".chr($i+65)."</a></td>\n";
     }
     echo "</tr>\n";
     echo "</table>\n";
echo "</td>\n";
...
echo "<td>\n";
     echo "<table width='100%'>\n";
     echo "<tr class='judul'>\n";
     echo "<td width='60%'><a href='list_pengguna.php?pfld=".$pfld."&pfltr=".$pfltr."&pnama=$pnama&porder=N'>Nama</a></td>\n";
     echo "<td width='40%'><a href='list_pengguna.php?pfld=".$pfld."&pfltr=".$pfltr."&pnama=$pnama&porder=U'>Unit Kerja</a></td>\n";
     echo "</tr>\n";
     while ($row = mysql_fetch_array($pengguna)) {
         $pval = $row["kode_pengguna"].",".$row[nama_pengguna];
         echo "<tr>\n";
         echo "<td width='60%'><a href=\"javascript:pick('".$pfld."','".$pval."')\">".$row["nama_pengguna"]."</td>\n";
