<?php
/******************************************
Nama File : kd_jnsproyek.php
Fungsi    : Setup kode jenis proyek
Dibuat    :	
 Tgl.     : 
 Oleh     : FB
...
$sqltext = "select * from kd_jns_proyek order by kode";
$query = mysql_query($sqltext, $db);

echo "<html>\n";
echo "<head>\n";
echo "<title>Kode Jenis Proyek</title>\n";
...
echo "<tr>\n";
echo "<td colspan=2 class='judul1'>Kode Jenis Proyek</td>\n";
echo "</tr>\n";
echo "</table>\n";

//echo "<h2><b>Kode Jenis Proyek</b></h2><p>\n";

echo "<form name='hapus_jnsproyek' method='post' action='post_kdproyek.php' target='isi'>\n";
echo "<table width='100%' border=0>\n";
...
while ($row = mysql_fetch_array($query)) {
    ...
    echo "<td class='isi2' width='5%'><a href='kd_jnsproyek.php?pid=".$row["kode"]."#form'><img src='../gambar/pen.gif' width='17' height='17' border=0></a>&nbsp;</td>\n";
...
if ($i==0) {
    ...
    echo "<input type=hidden name=namaform value='hapusjnsproyek'>\n";
    echo "<tr>\n";
...
function form_edit_kode($kode,$nama,$singk) {
    echo "<p id='form'>\n";
    echo "<form name='jnsproyek' method='post' action='post_kdproyek.php' target='isi'>\n";
    echo "<input type=hidden name=namaform value='jnsproyek'>\n";
    if (is_null($kode)) {
    ...
    echo "<table width='100%' border=0>\n";
    echo "<tr>\n";
    echo "<td class='judul1' colspan=2>Penambahan / Ubah Kode Jenis Proyek </td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
