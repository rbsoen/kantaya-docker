/***********************************************
Nama File : navigasi_timesheet.js (javascript)
Fungsi    : Navigasi Pemakaian Personil Proyek
            dgn. melacak akses unit kebawahnya
            dan pencarian personil.
Dibuat    :	
 Tgl.     : 14-10-2001
 Oleh     : AS
...
function printNavigasi() {
    ...
    document.writeln("<title>Navigasi Pemakaian Personil</title>");
    ...
    document.writeln("<script language='Javascript' src='navigasi_pemakaian_personil.js'></script>");
...
function printNavigasiunit() {
    document.writeln("<table width='100%' Border='0'>\n");
		document.writeln("<tr>");
		document.writeln("<td colspan=10 class='judul1'>List Unit</td>");
		document.writeln("</tr>");		
    var plevel = 0;
    var expand = true;
    ...
    for (var i=0; i<x.length; i++) {
        if (expand || x[i][2] <= plevel) {
           ...
           document.writeln("<a href='pemakaian_personil.php?punitnav="+x[i][0]+"&pseunit="+seunit+"&pabjad=Semua' target='isi'>"+x[i][1]+"</a><br>");
           document.writeln("</td>");
           document.writeln("</tr>");
        }
    }
...
function printNavigasicari() {
    document.writeln("<table width='100%' Border='0'>");
    document.writeln("<form name='caripengguna' method=post action='pemakaian_personil.php'  target='isi'>");
