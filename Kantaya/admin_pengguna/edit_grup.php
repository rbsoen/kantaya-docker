...
$result = mysql_query("SELECT kode_grup, nama_grup, sifat_grup, status FROM grup WHERE dibuat_oleh='$kode_pengguna' and status='1' order by nama_grup");
if ($data=mysql_fetch_array($result)) {
  echo "<center>Berikut adalah Grup yang Anda pimpin:<p>\n";
