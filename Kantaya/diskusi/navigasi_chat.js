...
Fungsi    : Menampilkan menu navigasi unit dan grup (javascript)
Dibuat    :
Tgl.      : 07-11-2001
Oleh      : FB
...
function printNavigasi() {
    ...
    document.writeln("<title>Navigasi Modul Diskusi</title>");
    ...
    document.writeln("<script language='Javascript' src='navigasi_chat.js'></script>");
...
function printNavigasipublik() {
    document.writeln("<table width='100%' Border='0'>");
    document.writeln("<tr>");
    document.writeln("<td><a href='list_kamar.php?p1=P' target='isi'>Publik</a></td>");
    document.writeln("</tr>");
    document.writeln("<tr>");
...
function printNavigasiunit() {
    ...
    for (var i=0; i<x.length; i++) {
        if (expand || x[i][2] <= plevel) {
           ...
           document.writeln("<a href='list_kamar.php?p1=U&p2="+x[i][0]+"' target='isi'>"+x[i][1]+"</a><br>");
           document.writeln("</td>");
           document.writeln("</tr>");
        }
    }
    ...
    for (var i=0; i<g.length; i++) {
        if (expand || g[i][2] <= plevel) {
           ...
           if (g[i][2] == 1) {
               ...
               document.writeln("<a href='list_kamar.php?p1=G&p2="+g[i][0]+"' target='isi'>"+g[i][1]+"</a><br>");
           }
           document.writeln("</td>");
           document.writeln("</tr>");
        }
