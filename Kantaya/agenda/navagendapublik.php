...
echo "    <tr>\n";
echo "      <td class=judul1 colspan=2 bgcolor='#225F95'>\n";
...
echo "               <a href='javascript:mingguan($kd_pgn,$mng,$bln,$thn)'> Mingguan</a> | \n";
echo "							 <a href='javascript:bulanan($kd_pgn,$bln,$thn)'> Bulanan</a></font></p>\n";
echo "             </td>\n";
echo "           </tr>\n";
echo "				 </table>\n";

echo "
		 					 <table border=0 width=100% class=tblabu2>
  						   <tr>
    						 	 <td colspan=7 align=center><b>
		";
		$thn_sblm = $thn - 1; 
		print("<font size=1 face=Verdana><b><a href='javascript:harian($kd_pgn,$tgl,$bln,$thn_sblm)'><< </a></b>&nbsp;</font>\n");
		$bln_sblm = $bln - 1;
		$thns = $thn;
		if ($bln_sblm == 0) {$bln_sblm = 12; $thns = $thn_sblm;}
		print("<font size=1 face=Verdana><b><a href='javascript:harian($kd_pgn,$tgl,$bln_sblm,$thns)'><</a></b>&nbsp;</font>\n");
		print("<font size=1 face=Verdana color=red>".namabulan('P',$bln)."&nbsp;$thn&nbsp;&nbsp;</font>\n");
		$bln_ssdh = $bln + 1; 
		$thn_ssdh = $thn + 1;
		$thnb = $thn;
		if ($bln_ssdh == 13) {$bln_ssdh = 1; $thnb = $thn_ssdh;}
		print("<font size=1 face=Verdana><b><a href='javascript:harian($kd_pgn,$tgl,$bln_ssdh,$thnb)'>></a></b>&nbsp;</font>\n");
		print("<font size=1 face=Verdana><b><a href='javascript:harian($kd_pgn,$tgl,$bln,$thn_ssdh)'> >></a></b>&nbsp;</font>\n");
echo"
     						  </b></td>
  							 </tr>
  							<tr>
	...
	for ($i=0; $i<count($kalender); $i++) {
		...
		for ($j=0; $j<7; $j++) {
			if ($kalender[$i][$j] == 0) {
				...
				else {print "<font size=1 face=Verdana><a href='javascript:harian($kd_pgn,$tgl_kal,$bln,$thn)'>".$kalender[$i][$j]."</a></font></td>\n";}
			}
		}
		print "   </tr>\n";
	}
echo"
		     <tr>
		 		  <td width=100% colspan=7><font size=1><a href='javascript:harian($kd_pgn,$tgl_skrg,$bln_skrg,$thn_skrg)'><b>Hari ini</b></a> : 
...
echo "               <a href='javascript:harian($kd_pgn,$tgl,$bln,$thn)'> Harian</a> | \n";
echo "               Mingguan |\n";
echo "							 <a href='javascript:bulanan($kd_pgn,$bln,$thn)'> Bulanan</a></font></p>\n";
echo "             </td>\n";
echo "
...
echo"
				 		<td><a href='javascript:mingguan($kd_pgn,$mngs,$bln,$thn)'><center><font size=2>Minggu $k</font></center></a></td>
				 	</tr>
";
   }
echo"
		     <tr>
		 		  <td width=100% ><font size=1><a href='javascript:harian($kd_pgn,$tgl_skrg,$bln_skrg,$thn_skrg)'><b>Hari ini</b></a> : 
		 		 		<font face=Verdana><b>".namahari("P",$hari_skrg).", ".$tgl_skrg." ".namabulan("P",$bln_skrg)." ".$thn_skrg."</b></font></font></td>
		 		 </tr>
";
   break;
...
";
		$thn_sblm = $thn - 1; 
		$thn_ssdh = $thn + 1;
		print("<font size=1 face=Verdana><b><a href='javascript:bulanan($kd_pgn,$bln,$thn_sblm)'>< </a></b>&nbsp;</font>\n");
		print("<font size=1 face=Verdana color=red>&nbsp;$thn&nbsp;</font>\n");
		print("<font size=1 face=Verdana><b><a href='javascript:bulanan($kd_pgn,$bln,$thn_ssdh)'> ></a></b>&nbsp;</font>\n");
echo"
				     </b></td>
				   </tr>
";
   for ($m=1; $m<13; $m+=3) {
	 		 $mm = $m + 1; $mmm = $m +2;
echo "		     <tr>\n";
echo "		 		 		<td align=center><a href='javascript:bulanan($kd_pgn,$m,$thn)'><font size=2>".namabulan("S",$m)."</font></a></td>\n";
echo "		 		 		<td align=center><a href='javascript:bulanan($kd_pgn,$mm,$thn)'><font size=2>".namabulan("S",$mm)."</font></a></td>\n";
echo "		 		 		<td align=center><a href='javascript:bulanan($kd_pgn,$mmm,$thn)'><font size=2>".namabulan("S",$mmm)."</font></a></td>\n";
echo "		     </tr>\n";
   }
echo"
		     <tr>
		 		  <td width=100% colspan=3><font size=1><a href='javascript:harian($kd_pgn,$tgl_skrg,$bln_skrg,$thn_skrg)'><b>Hari ini</b></a> : 
		 		 		<font face=Verdana><b>".namahari("P",$hari_skrg).", ".$tgl_skrg." ".namabulan("P",$bln_skrg)." ".$thn_skrg."</b></font></font></td>
		 		 </tr>
";
   break;
...
";
echo "<a href='javascript:harian(0,$tgl,$bln,$thn)'>Kembali ke agenda pribadi</a><br>";
...
echo "  <center>\n";
echo "        <div align=left>\n";
echo "				 <form name='cari' method='post' target='isi' ACTION='navagendapublik.php'>\n";
echo "          <table border=0 width=100% cellspacing=0 cellpadding=2>\n";
echo "            <tr>\n";
